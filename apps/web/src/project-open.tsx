...
export function ProjectOpen({ url, stack, onStackAction }: { url?: string; stack?: ProjectStack; onStackAction?: (action: StackAction) => Promise<unknown> | unknown }) {
