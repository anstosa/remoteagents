...
function ClientSettingsMenu({ settings }: { settings: ClientSettings }) {
  ...
  const settingsRows = <div className="client-settings-overview">
    ...
    {terminalFontSetting}{themeSetting}{agentsSetting}
  </div>;
